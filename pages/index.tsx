      ...
      <div className={styles.container}>
        <main className={styles.main}>
          ...
          <h1 className={styles.title}>
            Bienvenido a <a className={styles.noCursor} href="#">Crypto list!</a>
          </h1>
          ...
          <div>
            <strong className={styles.noCursor}> 
              <WalletOutlined /> Cryptocurrencies: {globalCryptoList?.coins_count} {''} 
...
export const getStaticProps = myStore.getStaticProps((store) => () => {
  store.dispatch(getCryptoAction())
